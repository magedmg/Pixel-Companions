...
void createAnimation3(int, int[2], Texture2D *, const char *);
...
DogX::DogX() {
  ...
  // still
  createAnimation3(4, catSize, standTextures, "cat/1");
  createAnimation3(6, catSize, runRightTextures, "cat/2");
  createAnimation3(6, catSize, runLeftTextures, "cat/3");
...
void createAnimation3(int numLoop, int sizes[2], Texture2D *textures,
                      const char *path) {
