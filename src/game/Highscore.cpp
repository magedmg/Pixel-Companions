...
void Highscore::addHighscore(int score, string petBreed) {
  ...
  // checks if incoming score is higher than current scores/number of entries,
  // and inserts it
...
string Highscore::getShibaScore() { return shibaScore; }

string Highscore::getPinkCatScore() { return pinkCatScore; }

string Highscore::getGreyCatScore() { return greyCatScore; }
